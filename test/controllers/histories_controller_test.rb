...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { lineno: @history.lineno, post_id: @history.post_id, reader_id: @history.reader_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { lineno: @history.lineno, post_id: @history.post_id, reader_id: @history.reader_id } }
