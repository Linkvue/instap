...
class ExcerptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create excerpt" do
    assert_difference('Excerpt.count') do
      post excerpts_url, params: { excerpt: { content: @excerpt.content, post_id: @excerpt.post_id, reader_id: @excerpt.reader_id } }
    end
  ...
  test "should update excerpt" do
    patch excerpt_url(@excerpt), params: { excerpt: { content: @excerpt.content, post_id: @excerpt.post_id, reader_id: @excerpt.reader_id } }
